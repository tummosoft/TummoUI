...
public class NotificationHelper extends AbsObjectWrapper<Object> {
    ...
    /**
     * Initializes the notification. By default the notification plays a sound,
     * shows a light and vibrates the phone.
     */
    NotificationManager notificationManager;
    public void Initialize(BA ba) {
        Initialize2(ba, IMPORTANCE_DEFAULT);
        
    }

    /**
     * Initializes the notification and sets the notification channel importance
     ...
     */
    public void Initialize2(BA ba, int ImportanceLevel) {
        NotificationData nd = new NotificationData();
        nd.importanceLevel = ImportanceLevel;
        nd.defaults = Notification.DEFAULT_ALL;
        setObject(nd);
        notificationManager = ba.context.getSystemService(NotificationManager.class);
    }
    ...
    /**
     * Sets whether the notification will vibrate.      Example:<code>
    ...
    /**
     * Sets whether the notification will play a sound.      Example:<code>
	 *n.Sound = False</code>
     */
    ...
    /**
     * Sets whether the notification will show a light.      Example:<code>
	 *n.Light = False</code>
     */
    ...
    /**
     * Sets whether the notification will be canceled automatically when the
     * user clicks on it.
     */
    ...
    /**
     * Sets whether the sound will play repeatedly until the user opens the
    ...
    /**
     * Sets whether this notification is an "ongoing event". The notification
     * will be displayed in the ongoing section and it will not be cleared.
     */
    ...
    /**
     * Gets or sets a number that will be displayed on the icon. This is useful
     * to represent multiple events in a single notification.
     */
    ...
    /**
     * Sets the icon displayed. The icon value is the name of the image file
    ...
    /**
     * Sets the message text and action. Title - The message title. Body - The
    ...
    /**
     * Similar to SetInfo. Also sets a string that can be later extracted in
...
//					channel.enableVibration((nd.defaults & Notification.DEFAULT_VIBRATE) != 0);
    ...
    /**
     * Displays the notification. Id - The notification id. This id can be used
     * to later update this notification (by calling Notify again with the same
     * Id), or to cancel the notification.
     */
    ...
    private NotificationChannel channel = null;
     ...
     @DesignerName("SetInfo3New")
    public void SetInfo3New(BA ba, CharSequence Title, CharSequence Body, CharSequence Tag, Object Activity, xRemoteView remoteViews) throws ClassNotFoundException {
        Intent i = Common.getComponentIntent(ba, Activity);
        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        if (Tag != null) {
...
//					channel.enableVibration((nd.defaults & Notification.DEFAULT_VIBRATE) != 0);
            ...
            .setContentText(Body)
            .setCustomContentView(remoteViews.getObject())
            .setContentIntent(pi);
            //.setCustomContentView(remoteViews.getObject());
    ...
    public void showDownloadNotification(BA ba, int iconRes, String title, String content, int progress, xRemoteView remoteViews) {
        
    NotificationCompat.Builder builder = new NotificationCompat.Builder(ba.context, "download_channel")
            .setContentTitle(title)
            .setContentText(content)
            .setSmallIcon(ba.context.getApplicationInfo().icon)            
            .setCustomContentView(remoteViews.getObject())
            .setPriority(NotificationCompat.PRIORITY_LOW);

    
        NotificationManager manager = (NotificationManager) ba.context.getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    public void setBypassDnd(boolean value) {
       channel.setBypassDnd(value);
    }
    
    public void enableLights(boolean value) {
       channel.enableLights(value);
    }
    
    public void setLightColor(String value) {
       channel.setLightColor(Color.parseColor(value));
    }
    
    public void NotificationChannel(BA ba, String chanelID, String name, int importance) {        
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {            
            channel = new NotificationChannel(chanelID, name, importance);            
    ...
    public static void openNotifyPermissionSetting(Context context) {
        try {
           ...
           //Jump directly to the code for app notification settings:
            ...
            //4.4 and below do not have an Action to jump from the app to the app notification settings page. You can consider jumping to the app details page.
